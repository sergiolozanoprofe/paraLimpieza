...
public class Constantes {
    ...
    public static final String NOMBRE_DEL_USUARIO = "Nombre del usuario: ";
    public static final String ESPACIO = "";
    public static final String EMAIL = "Email: ";
    public static final String INTRODUCE_EL_NOMBRE_DE_USUARIO = "Introduce el nombre de usuario: ";
